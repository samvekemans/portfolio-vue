<template>
    <div class="p-7">
        ...
        <nav ref="nav" class="border-b-2 border-border pb-2 nav-disabled relative">
            <svg @click="disableNav" class="white absolute top-7 left-7 h-12 w-12 hidden 700:block" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve">
